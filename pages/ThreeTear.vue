...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      class Photo {
        constructor(textures, destroyCallback) {
      ...
      const images = [
        {
          texture: textureLoader.load(
            "https://assets.codepen.io/557388/photo-4.jpg",
          ),
          colors: [
            [192, 208, 220],
            [217, 190, 174],
        ...
        {
          texture: textureLoader.load(
            "https://assets.codepen.io/557388/photo-3.jpg",
          ),
          colors: [
            [168, 163, 150],
            [218, 180, 141],
      ...
      const extraImages = [
        {
          file: "https://assets.codepen.io/557388/photo-1.jpg",
          colors: [
            [208, 229, 224],
            [209, 209, 220],
          ],
