<template>
  <!-- https://codepen.io/jonroc/pen/XWbqNWK -->
  <div class="container">
    <div class="hideMe">
      <h1>My Works</h1>
      ...
      <div id="masterWrap">
        <div id="panelWrap">
          ...
          <section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/greensock-logo.svg" width="300">
            <p>This slider demo is powered by GSAP 3 along with</p>
          </section>
          <section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/clock.png" width="75">
            <h3>Bottom dot animation</h3>
            <p>See that animationasedKeep an eye on it as you drag</p>
          </section>
          <section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/sleepingDogShadow.svg" width="250">
            <h3>Random dog </h3>
            <p>Why? Because dogs are cool.</p>
          </section>
          <section id="section6"> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/handTablet.svg" width="200">
            <h3>Handy for many things</h3>
            <p>We all need a full-screen slider from time to time.</p>
          </section>
          <section> <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/314556/craigmasternew.png" width="100">
...
export default {
  setup () {
    onMounted(() => {
      ...
      addEventListener('resize', sizeIt)
