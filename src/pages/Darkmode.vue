...
export default {
  ...
  setup () {
    ...
    onMounted(() => {
      // 배경 변경
      backgroundAni.to(stars.value, { opacity: 1, duration: 0.1 })
      backgroundAni.from(sky.value, { background: '#a0d2e6', duration: 0.1 })
      backgroundAni.to(twinkle.value, { opacity: 1, duration: 0.1 })
      // 토글 위치 이동
