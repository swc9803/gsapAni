<template>
  <div class="container" ref="background">
    <Squiggly />
    <div class="toggle" ref="togglebackground">
      <div @click="toggle(), toggledata = !toggledata" class="sunwrap" ref="suntoggle">
...
export default {
  ...
  setup () {
    ...
    onMounted(() => {
      ...
      // 토글 배경 변경
      togglebackAni.to(togglebackground.value, { background: '#82cce9', duration: 0.3 })
      // sun 색 변경
      gsap.to(sun.value, {
        stroke: '#ffa459',
        duration: 2,
